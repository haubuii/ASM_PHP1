...
<?php
    ...
    if(isset($_POST['btn_them']) && empty($errors)){
        ...
        $sql_insert = "INSERT INTO category(category_name) 
        VALUES ('$name')";
...
<body>
    <div class="product_container_input">
        <div class="card">
            <h2 class="card-header">Thông tin Thể Loại</h2>
            <div class="card-body">
                <form action="" method ="POST" enctype="multipart/form-data" >
                    <div class="form_group">
                        <label for="category_name">Tên Thể Loại</label>
                        <input type="text" name = "category_name" class="form-control" value=" <?php echo (!empty($_POST['category_name'])) ? $_POST['category_name'] : false ?>">
                        <span class="err">
                            <?php
